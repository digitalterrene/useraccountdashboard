  ...
  return (
    <div className="">
      <button
        ...
        className=" lg:px-4 flex items-center justify-center  gap-2 rounded-md border border-transparent text-sm hover:bg-blue-500 hover:text-white  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all  dark:focus:ring-offset-gray-800"
      >
        <PiSignIn className="text-2xl rotate-180" />
      ...
      {showModal && (
        <div
          ...
          className="hs-overlay hidden w-full h-full fixed top-0 start-0 z-[999] overflow-x-hidden overflow-y-auto"
        >
